/* Generated by Cython 0.12.alpha0 on Sun Nov 15 09:23:01 2009 */
...
/* "/usr/local/src/tctable/src/ctctable.pyx":290
...
struct __pyx_opt_args_8ctctable_7TCTable_get {
  int __pyx_n;
  PyObject *__pyx_default;
};

/* "/usr/local/src/tctable/src/ctctable.pyx":533
 * 
 * 
...
/* "/usr/local/src/tctable/src/ctctable.pyx":441
 *         return li
 * 
...
/* "/usr/local/src/tctable/src/ctctable.pyx":37
...
/* "/usr/local/src/tctable/src/ctctable.pyx":543
...
struct __pyx_vtabstruct_8ctctable_TCTable {
  ...
  PyObject *(*_put_keep_code)(struct __pyx_obj_8ctctable_TCTable *, int, PyObject *);
...
static PyTypeObject *__pyx_ptype_8ctctable_TCMap = 0;
static PyTypeObject *__pyx_ptype_8ctctable_TCQuery = 0;
static struct __pyx_obj_8ctctable_TCMap *__pyx_f_8ctctable_make_tcmap(void); /*proto*/
...
static char __pyx_k_5[] = "Unable to tune {0}.";
static char __pyx_k_6[] = "Unable to set mmap size {0}.";
static char __pyx_k_7[] = "Unable to setcache {0}.";
static char __pyx_k_8[] = "Unable to open {0} for {1}.";
static char __pyx_k_9[] = "Error: attempting to add to non-existing key: %s";
static char __pyx_k_10[] = "error in put ";
static char __pyx_k_11[] = " ";
static char __pyx_k_12[] = "mode must be one of p/k/c";
static char __pyx_k_13[] = "Unable to write to ";
static char __pyx_k_14[] = "Lookup failed: ";
static char __pyx_k_15[] = "";
static char __pyx_k_16[] = "Unable to write key \"{0}\".";
static char __pyx_k_17[] = "Key not found: \"{0}\"";
...
static char __pyx_k_21[] = "tokyo_cabinet_version";
static char __pyx_k_22[] = "0.1.1";
static char __pyx_k_23[] = "An error communicating with the Tokyo Cabinet database.";
...
/* "/usr/local/src/tctable/src/ctctable.pyx":47
...
static PyObject *__pyx_pf_8ctctable_7TCTable___repr__(PyObject *__pyx_v_self) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":48
 * 
 *     def __repr__(self):
 *         c = self.__class__.__name__             # <<<<<<<<<<<<<<
 *         return "%s('%s')" % (c, self.path)
...
static PyObject *__pyx_pf_8ctctable_7TCTable__throw(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":55
 *         from the table database.
 *         '''
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = ((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->_msg(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), 0); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
...
static PyObject *__pyx_pf_8ctctable_7TCTable__msg(PyObject *__pyx_v_self, PyObject *unused); /*proto*/
static  PyObject *__pyx_f_8ctctable_7TCTable__msg(struct __pyx_obj_8ctctable_TCTable *__pyx_v_self, int __pyx_skip_dispatch) {
  ...
  /* Check if overriden in Python */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    if (!PyCFunction_Check(__pyx_t_1) || (PyCFunction_GET_FUNCTION(__pyx_t_1) != (void *)&__pyx_pf_8ctctable_7TCTable__msg)) {
      __Pyx_XDECREF(__pyx_r);
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":61
 *         of *message* the last error message from the table database.
 *         '''
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":62
 *         '''
 *         cdef int errorcode = tctdbecode(self._state)
 *         return tctdberrmsg(errorcode)             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pf_8ctctable_7TCTable__msg(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  __Pyx_RefNannySetupContext("_msg");
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = ((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->_msg(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), 1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pf_8ctctable_7TCTable_optimize(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("ctctable.TCTable.optimize");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
 ...
 * 
 */
  __pyx_t_1 = PyObject_RichCompare(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->mode, ((PyObject *)__pyx_n_s__w), Py_NE); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_INCREF(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->path);
    PyTuple_SET_ITEM(__pyx_t_1, 0, ((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->path);
    __Pyx_GIVEREF(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->path);
    __pyx_t_5 = PyObject_Call(((PyObject *)((PyObject*)&PyString_Type)), __pyx_t_1, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* "/usr/local/src/tctable/src/ctctable.pyx":76
 * 
 * 
...
static int __pyx_pf_8ctctable_7TCTable___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (values[2]) {
      __pyx_v_bnum = __Pyx_PyInt_from_py_int64_t(values[2]); if (unlikely((__pyx_v_bnum == (int64_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_bnum = ((int64_t)-1);
    }
    if (values[3]) {
      __pyx_v_apow = __Pyx_PyInt_from_py_int8_t(values[3]); if (unlikely((__pyx_v_apow == (int8_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_apow = ((int8_t)-1);
    }
    if (values[4]) {
      __pyx_v_fpow = __Pyx_PyInt_from_py_int8_t(values[4]); if (unlikely((__pyx_v_fpow == (int8_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_fpow = ((int8_t)-1);
    }
    if (values[5]) {
      __pyx_v_opts = __Pyx_PyInt_from_py_uint8_t(values[5]); if (unlikely((__pyx_v_opts == (uint8_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_opts = ((uint8_t)0);
    }
    if (values[6]) {
      __pyx_v_mmap_size = __Pyx_PyInt_from_py_int64_t(values[6]); if (unlikely((__pyx_v_mmap_size == (int64_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_mmap_size = ((int64_t)-1);
    }
    if (values[7]) {
      __pyx_v_rcnum = __Pyx_PyInt_from_py_int32_t(values[7]); if (unlikely((__pyx_v_rcnum == (int32_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_rcnum = ((int32_t)-1);
    }
    if (values[8]) {
      __pyx_v_lcnum = __Pyx_PyInt_from_py_int32_t(values[8]); if (unlikely((__pyx_v_lcnum == (int32_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_lcnum = ((int32_t)-1);
    }
    if (values[9]) {
      __pyx_v_ncnum = __Pyx_PyInt_from_py_int32_t(values[9]); if (unlikely((__pyx_v_ncnum == (int32_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
    ...
    __pyx_v_ncnum = ((int32_t)-1);
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      case 10: __pyx_v_ncnum = __Pyx_PyInt_from_py_int32_t(PyTuple_GET_ITEM(__pyx_args, 9)); if (unlikely((__pyx_v_ncnum == (int32_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  9: __pyx_v_lcnum = __Pyx_PyInt_from_py_int32_t(PyTuple_GET_ITEM(__pyx_args, 8)); if (unlikely((__pyx_v_lcnum == (int32_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  8: __pyx_v_rcnum = __Pyx_PyInt_from_py_int32_t(PyTuple_GET_ITEM(__pyx_args, 7)); if (unlikely((__pyx_v_rcnum == (int32_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  7: __pyx_v_mmap_size = __Pyx_PyInt_from_py_int64_t(PyTuple_GET_ITEM(__pyx_args, 6)); if (unlikely((__pyx_v_mmap_size == (int64_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  6: __pyx_v_opts = __Pyx_PyInt_from_py_uint8_t(PyTuple_GET_ITEM(__pyx_args, 5)); if (unlikely((__pyx_v_opts == (uint8_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  5: __pyx_v_fpow = __Pyx_PyInt_from_py_int8_t(PyTuple_GET_ITEM(__pyx_args, 4)); if (unlikely((__pyx_v_fpow == (int8_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  4: __pyx_v_apow = __Pyx_PyInt_from_py_int8_t(PyTuple_GET_ITEM(__pyx_args, 3)); if (unlikely((__pyx_v_apow == (int8_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  3: __pyx_v_bnum = __Pyx_PyInt_from_py_int64_t(PyTuple_GET_ITEM(__pyx_args, 2)); if (unlikely((__pyx_v_bnum == (int64_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__cinit__", 0, 1, 10, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("ctctable.TCTable.__cinit__");
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __Pyx_INCREF((PyObject *)__pyx_v_self);
 ...
 */
      __pyx_t_6 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s___throw); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_7 = PyObject_GetAttr(((PyObject *)__pyx_kp_s_5), __pyx_n_s__format); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __Pyx_GIVEREF(__pyx_v_path);
      __pyx_t_9 = PyObject_Call(((PyObject *)((PyObject*)&PyString_Type)), __pyx_t_8, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __pyx_t_9 = 0;
      __pyx_t_9 = PyObject_Call(__pyx_t_7, __pyx_t_8, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_9);
      ...
      __Pyx_GIVEREF(__pyx_t_9);
      __pyx_t_9 = 0;
      __pyx_t_9 = PyObject_Call(__pyx_t_6, __pyx_t_8, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_9);
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":102
 *             if not success:
 *                 self._throw('Unable to tune {0}.'.format(str(path)))
 *         if mmap_size != -1:             # <<<<<<<<<<<<<<
 *             success = tctdbsetxmsiz(self._state, mmap_size)
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/usr/local/src/tctable/src/ctctable.pyx":103
 *                 self._throw('Unable to tune {0}.'.format(str(path)))
 *         if mmap_size != -1:
 *             success = tctdbsetxmsiz(self._state, mmap_size)             # <<<<<<<<<<<<<<
 *             if not success:
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "/usr/local/src/tctable/src/ctctable.pyx":105
 *             success = tctdbsetxmsiz(self._state, mmap_size)
 *             if not success:
 *                 self._throw('Unable to set mmap size {0}.'.format(path))             # <<<<<<<<<<<<<<
 *         if rcnum > -1 or lcnum > -1 or ncnum > -1:
 ...
 */
      __pyx_t_9 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s___throw); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __pyx_t_8 = PyObject_GetAttr(((PyObject *)__pyx_kp_s_6), __pyx_n_s__format); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_8);
      ...
      __Pyx_GIVEREF(__pyx_v_path);
      __pyx_t_7 = PyObject_Call(__pyx_t_8, __pyx_t_6, NULL); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_6 = PyTuple_New(1); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __pyx_t_7 = 0;
      __pyx_t_7 = PyObject_Call(__pyx_t_9, __pyx_t_6, NULL); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":106
 *             if not success:
 *                 self._throw('Unable to set mmap size {0}.'.format(path))
 *         if rcnum > -1 or lcnum > -1 or ncnum > -1:             # <<<<<<<<<<<<<<
 *             success = tctdbsetcache(self._state, rcnum, lcnum, ncnum)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/usr/local/src/tctable/src/ctctable.pyx":107
 *                 self._throw('Unable to set mmap size {0}.'.format(path))
 *         if rcnum > -1 or lcnum > -1 or ncnum > -1:
 *             success = tctdbsetcache(self._state, rcnum, lcnum, ncnum)             # <<<<<<<<<<<<<<
 *             if not success:
 ...
 */
    ...
    /* "/usr/local/src/tctable/src/ctctable.pyx":108
 *         if rcnum > -1 or lcnum > -1 or ncnum > -1:
 *             success = tctdbsetcache(self._state, rcnum, lcnum, ncnum)
 *             if not success:             # <<<<<<<<<<<<<<
 *                 self._throw('Unable to setcache {0}.'.format(self.path))
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "/usr/local/src/tctable/src/ctctable.pyx":109
 *             success = tctdbsetcache(self._state, rcnum, lcnum, ncnum)
 *             if not success:
 *                 self._throw('Unable to setcache {0}.'.format(self.path))             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_7 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s___throw); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_6 = PyObject_GetAttr(((PyObject *)__pyx_kp_s_7), __pyx_n_s__format); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      ...
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_INCREF(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->path);
      PyTuple_SET_ITEM(__pyx_t_9, 0, ((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->path);
      __Pyx_GIVEREF(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->path);
      __pyx_t_8 = PyObject_Call(__pyx_t_6, __pyx_t_9, NULL); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __pyx_t_9 = PyTuple_New(1); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __pyx_t_8 = 0;
      __pyx_t_8 = PyObject_Call(__pyx_t_7, __pyx_t_9, NULL); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
 ...
 */
  __pyx_t_10 = __Pyx_PyBytes_AsString(__pyx_v_path); if (unlikely((!__pyx_t_10) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_8 = PyObject_RichCompare(__pyx_v_mode, ((PyObject *)__pyx_n_s__w), Py_EQ); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_1 = __Pyx_PyObject_IsTrue(__pyx_t_8); if (unlikely(__pyx_t_1 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  if (__pyx_t_1) {
    __pyx_t_11 = 6;
  } else {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":112
 * 
 *         success = tctdbopen(self._state, path, 6 if mode=='w' else 1)
 *         if not success:             # <<<<<<<<<<<<<<
 *             self._throw('Unable to open {0} for {1}.'.format(str(path)))
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/usr/local/src/tctable/src/ctctable.pyx":113
 *         success = tctdbopen(self._state, path, 6 if mode=='w' else 1)
 *         if not success:
 *             self._throw('Unable to open {0} for {1}.'.format(str(path)))             # <<<<<<<<<<<<<<
 * 
 *     def close(self):
 */
    __pyx_t_8 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s___throw); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_9 = PyObject_GetAttr(((PyObject *)__pyx_kp_s_8), __pyx_n_s__format); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    ...
    __Pyx_GIVEREF(__pyx_v_path);
    __pyx_t_6 = PyObject_Call(((PyObject *)((PyObject*)&PyString_Type)), __pyx_t_7, NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_7 = PyTuple_New(1); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_7);
    ...
    __pyx_t_6 = 0;
    __pyx_t_6 = PyObject_Call(__pyx_t_9, __pyx_t_7, NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_7 = PyTuple_New(1); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    __Pyx_GIVEREF(__pyx_t_6);
    __pyx_t_6 = 0;
    __pyx_t_6 = PyObject_Call(__pyx_t_8, __pyx_t_7, NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
    ...
    /* "/usr/local/src/tctable/src/ctctable.pyx":121
 *         if not self._state == NULL:
 *             tctdbdel(self._state)
 *             self._state = NULL             # <<<<<<<<<<<<<<
 * 
...
static  TCMAP *__pyx_f_8ctctable_7TCTable__dict_to_tcmap(struct __pyx_obj_8ctctable_TCTable *__pyx_v_self, PyObject *__pyx_v_d) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":130
 ...
 * 
 */
  __pyx_t_1 = PyObject_Length(((PyObject *)__pyx_v_d)); if (unlikely(__pyx_t_1 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_2 = PyDict_Items(((PyObject *)__pyx_v_d)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  for (;;) {
    ...
    if (PyTuple_CheckExact(__pyx_t_2) && likely(PyTuple_GET_SIZE(__pyx_t_2) == 2)) {
      ...
      __pyx_t_6 = PyObject_GetIter(__pyx_t_2); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_4 = __Pyx_UnpackItem(__pyx_t_6, 0); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_5 = __Pyx_UnpackItem(__pyx_t_6, 1); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      if (__Pyx_EndUnpack(__pyx_t_6) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_DECREF(__pyx_v_key);
      __pyx_v_key = __pyx_t_4;
      __pyx_t_4 = 0;
 ...
 */
    __pyx_t_7 = PyString_AsStringAndSize(__pyx_v_key, (&__pyx_v_kbuf), (&__pyx_v_ksiz)); if (unlikely(__pyx_t_7 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         return tcmap
 */
    __pyx_t_7 = PyString_AsStringAndSize(__pyx_v_val, (&__pyx_v_vbuf), (&__pyx_v_vsiz)); if (unlikely(__pyx_t_7 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 135; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

    /* "/usr/local/src/tctable/src/ctctable.pyx":136
 *             ps.PyString_AsStringAndSize(key, &kbuf, &ksiz)
 *             ps.PyString_AsStringAndSize(val, &vbuf, &vsiz)
 *             tcmapput(tcmap, kbuf, ksiz, vbuf, vsiz)             # <<<<<<<<<<<<<<
 *         return tcmap
...
/* "/usr/local/src/tctable/src/ctctable.pyx":139
 *         return tcmap
 * 
 *     def optimize_index(self, colname):             # <<<<<<<<<<<<<<
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyBytes_AsString(__pyx_v_colname); if (unlikely((!__pyx_t_1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 140; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_2 = __Pyx_PyBool_FromLong(((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->create_index(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), __pyx_t_1, ((PyObject *)__pyx_n_s__o), 0)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 140; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_AddTraceback("ctctable.TCTable.optimize_index");
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* "/usr/local/src/tctable/src/ctctable.pyx":141
 *     def optimize_index(self, colname):
 *         return self.create_index(colname, 'o')
 *     def delete_index(self, colname):             # <<<<<<<<<<<<<<
 *         return self.create_index(colname, 'v')
...
static PyObject *__pyx_pf_8ctctable_7TCTable_delete_index(PyObject *__pyx_v_self, PyObject *__pyx_v_colname) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":142
 *         return self.create_index(colname, 'o')
 *     def delete_index(self, colname):
 *         return self.create_index(colname, 'v')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyBytes_AsString(__pyx_v_colname); if (unlikely((!__pyx_t_1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 142; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_2 = __Pyx_PyBool_FromLong(((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->create_index(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), __pyx_t_1, ((PyObject *)__pyx_n_s__v), 0)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 142; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_AddTraceback("ctctable.TCTable.delete_index");
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* "/usr/local/src/tctable/src/ctctable.pyx":144
 *         return self.create_index(colname, 'v')
 * 
 *     cpdef bint create_index(TCTable self, char* colname, idx_type):             # <<<<<<<<<<<<<<
 *         """
...
static PyObject *__pyx_pf_8ctctable_7TCTable_create_index(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static  int __pyx_f_8ctctable_7TCTable_create_index(struct __pyx_obj_8ctctable_TCTable *__pyx_v_self, char *__pyx_v_colname, PyObject *__pyx_v_idx_type, int __pyx_skip_dispatch) {
  ...
  /* Check if overriden in Python */
    ...
    __pyx_t_1 = PyObject_GetAttr(((PyObject *)__pyx_v_self), __pyx_n_s__create_index); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    if (!PyCFunction_Check(__pyx_t_1) || (PyCFunction_GET_FUNCTION(__pyx_t_1) != (void *)&__pyx_pf_8ctctable_7TCTable_create_index)) {
      __pyx_t_2 = __Pyx_PyBytes_FromString(__pyx_v_colname); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      ...
      __pyx_t_2 = 0;
      __pyx_t_2 = PyObject_Call(__pyx_t_1, __pyx_t_3, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely((__pyx_t_4 == (int)-1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_r = __pyx_t_4;
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      goto __pyx_L0;
 ...
 */
  ...
  __pyx_t_2 = PyInt_FromLong(TDBITLEXICAL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 150; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, ((PyObject *)__pyx_n_s__s), __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 150; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyInt_FromLong(TDBITDECIMAL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 150; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, ((PyObject *)__pyx_n_s__d), __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 150; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  __pyx_t_2 = PyInt_FromLong(TDBITOPT); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 151; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, ((PyObject *)__pyx_n_s__o), __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 150; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyInt_FromLong(TDBITVOID); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 151; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, ((PyObject *)__pyx_n_s__v), __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 150; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * 
 */
  __pyx_t_1 = PyObject_GetItem(__pyx_v_idx_lookup, __pyx_v_idx_type); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 152; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":153
 *                       'o': TDBITOPT, 'v': TDBITVOID }
 *         cdef int type = idx_lookup[idx_type]
 *         return tctdbsetindex(self._state, colname, type)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_WriteUnraisable("ctctable.TCTable.create_index");
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_DECREF(__pyx_v_idx_lookup);
  __Pyx_RefNannyFinishContext();
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("create_index", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "create_index") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_colname = __Pyx_PyBytes_AsString(values[0]); if (unlikely((!__pyx_v_colname) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_idx_type = values[1];
  } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
    goto __pyx_L5_argtuple_error;
  } else {
    __pyx_v_colname = __Pyx_PyBytes_AsString(PyTuple_GET_ITEM(__pyx_args, 0)); if (unlikely((!__pyx_v_colname) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_idx_type = PyTuple_GET_ITEM(__pyx_args, 1);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("create_index", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("ctctable.TCTable.create_index");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyBool_FromLong(((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->create_index(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), __pyx_v_colname, __pyx_v_idx_type, 1)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "/usr/local/src/tctable/src/ctctable.pyx":155
 *         return tctdbsetindex(self._state, colname, type)
 * 
 *     def put(TCTable self, k, dict d, mode='p'):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_8ctctable_7TCTable_put(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_8ctctable_7TCTable_put[] = " mode is one of p, k, c\n        'c' is put cat, which adds items to an existing dict.\n        'p' is put just writes to the key without regard for what's there\n        'k' will only put the new data if there is nothing currently at\n            that key.\n        ";
static PyObject *__pyx_pf_8ctctable_7TCTable_put(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("put", 0, 2, 3, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      if (kw_args > 1) {
        PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s__mode);
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "put") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_k = values[0];
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("put", 0, 2, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("ctctable.TCTable.put");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __Pyx_INCREF((PyObject *)__pyx_v_self);
  ...
  __Pyx_INCREF(__pyx_v_d);
  __Pyx_INCREF(__pyx_v_mode);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_d), &PyDict_Type, 1, "d", 1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_v_tcmap = ((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->_dict_to_tcmap(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), __pyx_v_d);
 ...
 */
  __pyx_t_1 = PyString_AsStringAndSize(__pyx_v_k, (&__pyx_v_kbuf), (&__pyx_v_ksiz)); if (unlikely(__pyx_t_1 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 167; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "/usr/local/src/tctable/src/ctctable.pyx":168
 *         cdef bint success
 *         ps.PyString_AsStringAndSize(k, &kbuf, &ksiz)
 *         if mode == 'c':             # <<<<<<<<<<<<<<
 *             success = tctdbputcat(self._state, kbuf, <int>ksiz, tcmap)
 *             if not success:
 */
  __pyx_t_2 = PyObject_RichCompare(__pyx_v_mode, ((PyObject *)__pyx_n_s__c), Py_EQ); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 168; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  if (__pyx_t_3) {
    ...
    /* "/usr/local/src/tctable/src/ctctable.pyx":169
 *         ps.PyString_AsStringAndSize(k, &kbuf, &ksiz)
 *         if mode == 'c':
 *             success = tctdbputcat(self._state, kbuf, <int>ksiz, tcmap)             # <<<<<<<<<<<<<<
 *             if not success:
 *                 if not k in d:
 */
    __pyx_v_success = tctdbputcat(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->_state, __pyx_v_kbuf, ((int)__pyx_v_ksiz), __pyx_v_tcmap);
 ...
 */
      if (unlikely(((PyObject *)__pyx_v_d) == Py_None)) {
        ...
        __pyx_t_3 = ((PyDict_Contains(((PyObject *)__pyx_v_d), __pyx_v_k))); if (unlikely(__pyx_t_3 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 171; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_t_4 = (!__pyx_t_3);
      if (__pyx_t_4) {
 ...
 *         elif mode == 'p':
 */
        __pyx_t_2 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s___throw); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 172; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
 ...
 */
        __pyx_t_5 = PyNumber_Remainder(((PyObject *)__pyx_kp_s_9), __pyx_v_k); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 173; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_5);
        ...
        __Pyx_GIVEREF(__pyx_t_5);
        __pyx_t_5 = 0;
        __pyx_t_5 = PyObject_Call(__pyx_t_2, __pyx_t_6, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 172; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":174
 *                     self._throw('Error: attempting to add to '\
 *                             'non-existing key: %s' % k)
 *         elif mode == 'p':             # <<<<<<<<<<<<<<
 *             success = tctdbput(self._state, kbuf, <int>ksiz, tcmap)
 *             if not success:
 */
  __pyx_t_5 = PyObject_RichCompare(__pyx_v_mode, ((PyObject *)__pyx_n_s__p), Py_EQ); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 174; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 */
    __pyx_v_success = tctdbput(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->_state, __pyx_v_kbuf, ((int)__pyx_v_ksiz), __pyx_v_tcmap);
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "/usr/local/src/tctable/src/ctctable.pyx":177
 *             success = tctdbput(self._state, kbuf, <int>ksiz, tcmap)
 *             if not success:
 *                 self._throw('error in put ' + k + ' ' + str(d))             # <<<<<<<<<<<<<<
 *         elif mode == 'k':
 ...
 */
      __pyx_t_5 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s___throw); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 177; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_6 = PyNumber_Add(((PyObject *)__pyx_kp_s_10), __pyx_v_k); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 177; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_2 = PyNumber_Add(__pyx_t_6, ((PyObject *)__pyx_kp_s_11)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 177; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      ...
      __pyx_t_7 = PyObject_Call(((PyObject *)((PyObject*)&PyString_Type)), __pyx_t_6, NULL); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 177; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_6 = PyNumber_Add(__pyx_t_2, __pyx_t_7); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 177; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      ...
      __Pyx_GIVEREF(__pyx_t_6);
      __pyx_t_6 = 0;
      __pyx_t_6 = PyObject_Call(__pyx_t_5, __pyx_t_7, NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 177; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
  __pyx_t_6 = PyObject_RichCompare(__pyx_v_mode, ((PyObject *)__pyx_n_s__k), Py_EQ); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 178; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_t_6); if (unlikely(__pyx_t_4 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 178; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  if (__pyx_t_4) {

    /* "/usr/local/src/tctable/src/ctctable.pyx":179
 *                 self._throw('error in put ' + k + ' ' + str(d))
 *         elif mode == 'k':
 *             success = tctdbputkeep(self._state, kbuf, ksiz, tcmap)             # <<<<<<<<<<<<<<
 *             return self._put_keep_code(success, k)
 *         else:
 */
    __pyx_v_success = tctdbputkeep(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->_state, __pyx_v_kbuf, __pyx_v_ksiz, __pyx_v_tcmap);

    /* "/usr/local/src/tctable/src/ctctable.pyx":180
 *         elif mode == 'k':
 *             success = tctdbputkeep(self._state, kbuf, ksiz, tcmap)
 *             return self._put_keep_code(success, k)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_6 = ((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->_put_keep_code(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), __pyx_v_success, __pyx_v_k); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 180; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_r = __pyx_t_6;
    __pyx_t_6 = 0;
    goto __pyx_L0;
 ...
 * 
 */
    __pyx_t_6 = __Pyx_GetName(__pyx_m, __pyx_n_s__TCException); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 182; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    ...
    __pyx_t_5 = PyObject_Call(__pyx_t_6, __pyx_t_7, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 182; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
...
static int __pyx_pf_8ctctable_7TCTable___setitem__(PyObject *__pyx_v_self, PyObject *__pyx_v_k, PyObject *__pyx_v_d); /*proto*/
static int __pyx_pf_8ctctable_7TCTable___setitem__(PyObject *__pyx_v_self, PyObject *__pyx_v_k, PyObject *__pyx_v_d) {
  TCMAP *__pyx_v_tcmap;
  char *__pyx_v_kbuf;
  Py_ssize_t __pyx_v_ksiz;
  int __pyx_v_success;
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":186
 * 
 *     def __setitem__(self, k, d):
 *         cdef TCMAP * tcmap = self._dict_to_tcmap(d)             # <<<<<<<<<<<<<<
 *         cdef char *kbuf
 *         cdef Py_ssize_t ksiz
 */
  if (!(likely(PyDict_CheckExact(__pyx_v_d))||((__pyx_v_d) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected dict, got %.200s", Py_TYPE(__pyx_v_d)->tp_name), 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 186; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_tcmap = ((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->_dict_to_tcmap(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), ((PyObject *)__pyx_v_d));

  /* "/usr/local/src/tctable/src/ctctable.pyx":190
 *         cdef Py_ssize_t ksiz
 *         cdef bint success
 *         ps.PyString_AsStringAndSize(k, &kbuf, &ksiz)             # <<<<<<<<<<<<<<
 ...
 *         tcmapdel(tcmap)
 */
  __pyx_t_1 = PyString_AsStringAndSize(__pyx_v_k, (&__pyx_v_kbuf), (&__pyx_v_ksiz)); if (unlikely(__pyx_t_1 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 190; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
    __pyx_t_3 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s___throw); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 195; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    ...
    __pyx_t_5 = PyObject_Call(((PyObject *)((PyObject*)&PyString_Type)), __pyx_t_4, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 195; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = PyNumber_Add(((PyObject *)__pyx_kp_s_13), __pyx_t_5); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 195; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    __pyx_t_4 = 0;
    __pyx_t_4 = PyObject_Call(__pyx_t_3, __pyx_t_5, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 195; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
static  PyObject *__pyx_f_8ctctable_7TCTable__tcmap_to_dict(struct __pyx_obj_8ctctable_TCTable *__pyx_v_self, TCMAP *__pyx_v_tcmap) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":198
 * 
 *     cdef dict _tcmap_to_dict(TCTable self, TCMAP *tcmap):
 *         cdef dict d = {}             # <<<<<<<<<<<<<<
 *         tcmapiterinit(tcmap)
 ...
 *             d[pykey] = pyval
 */
    __pyx_t_1 = PyString_FromStringAndSize(__pyx_v_kptr, ((Py_ssize_t)__pyx_v_ksiz)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 206; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_v_pykey);
    __pyx_v_pykey = __pyx_t_1;
    __pyx_t_1 = 0;

    /* "/usr/local/src/tctable/src/ctctable.pyx":207
 * 
 *             pykey = ps.PyString_FromStringAndSize(kptr, <Py_ssize_t>ksiz)
 *             pyval = ps.PyString_FromStringAndSize(vptr, <Py_ssize_t>vsiz)             # <<<<<<<<<<<<<<
 *             d[pykey] = pyval
 * 
 */
    __pyx_t_1 = PyString_FromStringAndSize(__pyx_v_vptr, ((Py_ssize_t)__pyx_v_vsiz)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 207; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
 ...
 */
    if (PyDict_SetItem(((PyObject *)__pyx_v_d), __pyx_v_pykey, __pyx_v_pyval) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 208; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

    /* "/usr/local/src/tctable/src/ctctable.pyx":210
 *             d[pykey] = pyval
 * 
 *             kptr = <char *>tcmapiternext(tcmap, &ksiz)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":212
 *             kptr = <char *>tcmapiternext(tcmap, &ksiz)
 * 
 *         return d             # <<<<<<<<<<<<<<
 * 
 ...
 *         if tcmap == NULL:
 */
  __pyx_t_1 = PyString_AsStringAndSize(__pyx_v_key, (&__pyx_v_kbuf), (&__pyx_v_ksiz)); if (unlikely(__pyx_t_1 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 220; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":222
 *         ps.PyString_AsStringAndSize(key, &kbuf, &ksiz)
 *         cdef TCMAP *tcmap = tctdbget(self._state, kbuf, <int>ksiz)
 *         if tcmap == NULL:             # <<<<<<<<<<<<<<
 *             raise KeyError('Lookup failed: ' + str(key))
 ...
 */
    ...
    __pyx_t_4 = PyObject_Call(((PyObject *)((PyObject*)&PyString_Type)), __pyx_t_3, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyNumber_Add(((PyObject *)__pyx_kp_s_14), __pyx_t_4); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __Pyx_GIVEREF(__pyx_t_3);
    __pyx_t_3 = 0;
    __pyx_t_3 = PyObject_Call(__pyx_builtin_KeyError, __pyx_t_4, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_Raise(__pyx_t_3, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":225
 *             raise KeyError('Lookup failed: ' + str(key))
 * 
 *         cdef dict d = self._tcmap_to_dict(tcmap)             # <<<<<<<<<<<<<<
 *         tcmapdel(tcmap)
 *         return d
 */
  __pyx_t_3 = ((PyObject *)((struct __pyx_vtabstruct_8ctctable_TCTable *)__pyx_v_self->__pyx_vtab)->_tcmap_to_dict(__pyx_v_self, __pyx_v_tcmap)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 225; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_v_d = ((PyObject *)__pyx_t_3);
  __pyx_t_3 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":226
 * 
 *         cdef dict d = self._tcmap_to_dict(tcmap)
 *         tcmapdel(tcmap)             # <<<<<<<<<<<<<<
 *         return d
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":227
 *         cdef dict d = self._tcmap_to_dict(tcmap)
 *         tcmapdel(tcmap)
 *         return d             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/local/src/tctable/src/ctctable.pyx":229
 *         return d
 * 
 *     cdef inline dict _ckey_to_dict(TCTable self, char *kbuf, int ksiz):             # <<<<<<<<<<<<<<
 *         cdef TCMAP *tcmap = tctdbget(self._state, kbuf, <int>ksiz)
...
static INLINE PyObject *__pyx_f_8ctctable_7TCTable__ckey_to_dict(struct __pyx_obj_8ctctable_TCTable *__pyx_v_self, char *__pyx_v_kbuf, int __pyx_v_ksiz) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":230
 * 
 *     cdef inline dict _ckey_to_dict(TCTable self, char *kbuf, int ksiz):
 *         cdef TCMAP *tcmap = tctdbget(self._state, kbuf, <int>ksiz)             # <<<<<<<<<<<<<<
 *         if tcmap == NULL:
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":231
 *     cdef inline dict _ckey_to_dict(TCTable self, char *kbuf, int ksiz):
 *         cdef TCMAP *tcmap = tctdbget(self._state, kbuf, <int>ksiz)
 *         if tcmap == NULL:             # <<<<<<<<<<<<<<
 *             raise KeyError('Lookup failed: ' + str(kbuf))
 ...
 *         tcmapdel(tcmap)
 */
    __pyx_t_2 = __Pyx_PyBytes_FromString(__pyx_v_kbuf); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 232; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    ...
    __Pyx_GIVEREF(__pyx_t_2);
    __pyx_t_2 = 0;
    __pyx_t_2 = PyObject_Call(((PyObject *)((PyObject*)&PyString_Type)), __pyx_t_3, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 232; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyNumber_Add(((PyObject *)__pyx_kp_s_14), __pyx_t_2); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 232; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    ...
    __Pyx_GIVEREF(__pyx_t_3);
    __pyx_t_3 = 0;
    __pyx_t_3 = PyObject_Call(__pyx_builtin_KeyError, __pyx_t_2, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 232; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_Raise(__pyx_t_3, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 *         return d
 */
  __pyx_t_3 = ((PyObject *)((struct __pyx_vtabstruct_8ctctable_TCTable *)__pyx_v_self->__pyx_vtab)->_tcmap_to_dict(__pyx_v_self, __pyx_v_tcmap)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 233; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_v_d = ((PyObject *)__pyx_t_3);
  __pyx_t_3 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":234
 *             raise KeyError('Lookup failed: ' + str(kbuf))
 *         cdef dict d = self._tcmap_to_dict(tcmap)
 *         tcmapdel(tcmap)             # <<<<<<<<<<<<<<
 *         return d
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_AddTraceback("ctctable.TCTable._ckey_to_dict");
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_d);
  __Pyx_DECREF((PyObject *)__pyx_v_self);
...
/* "/usr/local/src/tctable/src/ctctable.pyx":237
 *         return d
 * 
 *     def __iter__(self):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_8ctctable_7TCTable___iter__(PyObject *__pyx_v_self) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":238
 * 
 *     def __iter__(self):
 *         tctdbiterinit(self._state)             # <<<<<<<<<<<<<<
 *         return self
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":239
 *     def __iter__(self):
 *         tctdbiterinit(self._state)
 *         return self             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/local/src/tctable/src/ctctable.pyx":241
 *         return self
 * 
 *     def __next__(self):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":243
 *     def __next__(self):
 *         cdef TCMAP *tcmap = tctdbiternext3(self._state)
 *         if tcmap == NULL:             # <<<<<<<<<<<<<<
 *             raise StopIteration
 ...
 */
  __pyx_t_2 = ((PyObject *)((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->_tcmap_to_dict(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), __pyx_v_tcmap)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 245; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_v_d = ((PyObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":246
 *             raise StopIteration
 *         cdef dict d = self._tcmap_to_dict(tcmap)
 *         tcmapdel(tcmap)             # <<<<<<<<<<<<<<
 *         # the key is stored in the tcmap with its key as ''
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = PyObject_GetAttr(((PyObject *)__pyx_v_d), __pyx_n_s__pop); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 248; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("ctctable.TCTable.__next__");
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_d);
  __Pyx_DECREF((PyObject *)__pyx_v_self);
...
static PyObject *__pyx_pf_8ctctable_7TCTable_keep_or_put(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("keep_or_put", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 251; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "keep_or_put") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 251; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_k = values[0];
    __pyx_v_d = values[1];
  } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("keep_or_put", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 251; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
 ...
 */
  __pyx_t_1 = PyString_AsStringAndSize(__pyx_v_k, (&__pyx_v_kbuf), (&__pyx_v_ksiz)); if (unlikely(__pyx_t_1 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 259; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *                                           <int>ksiz, tcmap)
 */
  if (!(likely(PyDict_CheckExact(__pyx_v_d))||((__pyx_v_d) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected dict, got %.200s", Py_TYPE(__pyx_v_d)->tp_name), 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 260; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_tcmap = ((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->_dict_to_tcmap(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), ((PyObject *)__pyx_v_d));

  /* "/usr/local/src/tctable/src/ctctable.pyx":262
 *         cdef TCMAP * tcmap = self._dict_to_tcmap(d)
 *         cdef bint success = tctdbputkeep(self._state, <void *>kbuf,
 *                                           <int>ksiz, tcmap)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = ((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->_put_keep_code(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), __pyx_v_success, __pyx_v_k); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 265; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
...
static  PyObject *__pyx_f_8ctctable_7TCTable__put_keep_code(struct __pyx_obj_8ctctable_TCTable *__pyx_v_self, int __pyx_v_success, PyObject *__pyx_v_key) {
  int __pyx_v_errorcode;
  PyObject *__pyx_r = NULL;
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/usr/local/src/tctable/src/ctctable.pyx":270
 *         cdef int errorcode
 *         if not success:
 *             errorcode = tctdbecode(self._state)             # <<<<<<<<<<<<<<
 *             if errorcode == 21: # 'existing record'
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/usr/local/src/tctable/src/ctctable.pyx":274
 *                 return 'keep'
 *             else:
 *                 self._throw('Unable to write key "{0}".'.format(key))             # <<<<<<<<<<<<<<
 *         return 'put'
 * 
 */
      __pyx_t_2 = PyObject_GetAttr(((PyObject *)__pyx_v_self), __pyx_n_s___throw); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 274; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_3 = PyObject_GetAttr(((PyObject *)__pyx_kp_s_16), __pyx_n_s__format); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 274; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      ...
      __Pyx_GIVEREF(__pyx_v_key);
      __pyx_t_5 = PyObject_Call(__pyx_t_3, __pyx_t_4, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 274; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_4 = PyTuple_New(1); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 274; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __Pyx_GIVEREF(__pyx_t_5);
      __pyx_t_5 = 0;
      __pyx_t_5 = PyObject_Call(__pyx_t_2, __pyx_t_4, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 274; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_XDECREF(__pyx_t_5);
  __Pyx_AddTraceback("ctctable.TCTable._put_keep_code");
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_DECREF((PyObject *)__pyx_v_self);
  __Pyx_DECREF(__pyx_v_key);
...
static char __pyx_doc_8ctctable_7TCTable_setdefault[] = "Writes a record -- d[k] = d -- if k not in d.\n        Then returns d[k].\n        ";
static PyObject *__pyx_pf_8ctctable_7TCTable_setdefault(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_t_3 = NULL;
  int __pyx_t_4;
  struct __pyx_opt_args_8ctctable_7TCTable_get __pyx_t_5;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__k,&__pyx_n_s__d,0};
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("setdefault", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 277; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "setdefault") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 277; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_k = values[0];
    __pyx_v_d = values[1];
  } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("setdefault", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 277; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
 ...
 *         else:
 */
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s__keep_or_put); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 281; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_RichCompare(__pyx_t_3, ((PyObject *)__pyx_n_s__keep), Py_EQ); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 281; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  if (__pyx_t_4) {
    ...
    /* "/usr/local/src/tctable/src/ctctable.pyx":282
 *         '''
 *         if self.keep_or_put(k, d) == 'keep':
 *             return self.get(k, d)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    __pyx_t_2 = ((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->get(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), __pyx_v_k, 0, &__pyx_t_5); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 282; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_r = __pyx_t_2;
    __pyx_t_2 = 0;
    goto __pyx_L0;
...
/* "/usr/local/src/tctable/src/ctctable.pyx":286
 *             return d # which certainly has just been put
 * 
 *     def __getitem__(self, key):             # <<<<<<<<<<<<<<
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = ((PyObject *)((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->_key_to_dict(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), __pyx_v_key)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 288; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static  PyObject *__pyx_f_8ctctable_7TCTable_get(struct __pyx_obj_8ctctable_TCTable *__pyx_v_self, PyObject *__pyx_v_key, int __pyx_skip_dispatch, struct __pyx_opt_args_8ctctable_7TCTable_get *__pyx_optional_args) {
  ...
  /* Check if overriden in Python */
    ...
    __pyx_t_1 = PyObject_GetAttr(((PyObject *)__pyx_v_self), __pyx_n_s__get); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 290; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    if (!PyCFunction_Check(__pyx_t_1) || (PyCFunction_GET_FUNCTION(__pyx_t_1) != (void *)&__pyx_pf_8ctctable_7TCTable_get)) {
      __Pyx_XDECREF(__pyx_r);
      ...
      __pyx_t_3 = PyObject_Call(__pyx_t_1, __pyx_t_2, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 290; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_r = __pyx_t_3;
      __pyx_t_3 = 0;
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":291
 * 
 *     cpdef get(self, key, default=None):
 *         try:             # <<<<<<<<<<<<<<
 *             v = self._key_to_dict(key)
 ...
 *         except KeyError:
 */
      __pyx_t_1 = ((PyObject *)((struct __pyx_vtabstruct_8ctctable_TCTable *)__pyx_v_self->__pyx_vtab)->_key_to_dict(__pyx_v_self, __pyx_v_key)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 292; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      __Pyx_GOTREF(__pyx_t_1);
 ...
 */
      __Pyx_XDECREF(__pyx_r);
      __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_v_v); if (unlikely(__pyx_t_4 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 293; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      if (!__pyx_t_4) {
        __Pyx_INCREF(__pyx_v_default);
 ...
 */
    ...
    if (__pyx_t_5) {
      ...
      if (__Pyx_GetException(&__pyx_t_1, &__pyx_t_3, &__pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 294; __pyx_clineno = __LINE__; goto __pyx_L5_except_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_GOTREF(__pyx_t_2);
...
static PyObject *__pyx_pf_8ctctable_7TCTable_get(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = NULL;
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_8ctctable_7TCTable_get __pyx_t_2;
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "get") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 290; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
  ...
  __pyx_t_1 = ((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->get(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), __pyx_v_key, 1, &__pyx_t_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 290; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "/usr/local/src/tctable/src/ctctable.pyx":297
 *             return default
 * 
 *     def __delitem__(self, key):             # <<<<<<<<<<<<<<
 *         cdef char *kbuf
 ...
 *         if not success:
 */
  __pyx_t_1 = PyString_AsStringAndSize(__pyx_v_key, (&__pyx_v_kbuf), (&__pyx_v_ksiz)); if (unlikely(__pyx_t_1 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 300; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/usr/local/src/tctable/src/ctctable.pyx":303
 *         cdef bint success = tctdbout(self._state, kbuf, ksiz)
 *         if not success:
 *             raise KeyError(self._msg())             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_3 = ((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->_msg(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), 0); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 303; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    ...
    __Pyx_GIVEREF(__pyx_t_3);
    __pyx_t_3 = 0;
    __pyx_t_3 = PyObject_Call(__pyx_builtin_KeyError, __pyx_t_4, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 303; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_Raise(__pyx_t_3, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
...
/* "/usr/local/src/tctable/src/ctctable.pyx":305
 *             raise KeyError(self._msg())
 * 
 *     def pop(self, k, d=None):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_8ctctable_7TCTable_pop(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "pop") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 305; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_k = values[0];
    __pyx_v_d = values[1];
  } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("pop", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 305; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
 ...
 *             if d is None:
 */
  __pyx_t_1 = ((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->get(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), __pyx_v_k, 0, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 310; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_adict);
  __pyx_v_adict = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":311
 *         '''
 *         adict = self.get(k)
 *         if adict is None:             # <<<<<<<<<<<<<<
 *             if d is None:
 ...
 *                 return d
 */
      __pyx_t_1 = PyObject_GetAttr(((PyObject *)__pyx_kp_s_17), __pyx_n_s__format); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 313; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      ...
      __Pyx_GIVEREF(__pyx_t_4);
      __pyx_t_4 = 0;
      __pyx_t_4 = PyObject_Call(__pyx_builtin_KeyError, __pyx_t_3, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 313; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_Raise(__pyx_t_4, 0, 0);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 * 
 */
    if (PyObject_DelAttr(__pyx_v_self, __pyx_n_s__k) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 317; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

    /* "/usr/local/src/tctable/src/ctctable.pyx":318
 *         else:
 *             del self.k
 *             return adict             # <<<<<<<<<<<<<<
 * 
...
static  int __pyx_f_8ctctable_7TCTable_size_of(struct __pyx_obj_8ctctable_TCTable *__pyx_v_self, PyObject *__pyx_v_key, int __pyx_skip_dispatch) {
  ...
  /* Check if overriden in Python */
    ...
    __pyx_t_1 = PyObject_GetAttr(((PyObject *)__pyx_v_self), __pyx_n_s__size_of); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 320; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    if (!PyCFunction_Check(__pyx_t_1) || (PyCFunction_GET_FUNCTION(__pyx_t_1) != (void *)&__pyx_pf_8ctctable_7TCTable_size_of)) {
      ...
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_4 = __Pyx_PyInt_AsInt(__pyx_t_3); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 320; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_r = __pyx_t_4;
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      goto __pyx_L0;
 ...
 * 
 */
  __pyx_t_4 = PyString_AsStringAndSize(__pyx_v_key, (&__pyx_v_kbuf), (&__pyx_v_ksiz)); if (unlikely(__pyx_t_4 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 329; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pf_8ctctable_7TCTable_size_of(PyObject *__pyx_v_self, PyObject *__pyx_v_key) {
  ...
  __Pyx_RefNannySetupContext("size_of");
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyInt_FromLong(((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->size_of(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), __pyx_v_key, 1)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 320; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static int __pyx_pf_8ctctable_7TCTable___contains__(PyObject *__pyx_v_self, PyObject *__pyx_v_key) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":337
 *             d = D[id] if id in D else defaultdict
 *         '''
...
/* "/usr/local/src/tctable/src/ctctable.pyx":339
 *         return self.size_of(key) > -1
 * 
 *     def flush(self):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_8ctctable_7TCTable_flush(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":341
 *     def flush(self):
 *         '''Forces changes to be written to disk. Returns a success code.'''
 *         cdef bint success = tctdbsync(self._state)             # <<<<<<<<<<<<<<
 *         return success
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":342
 *         '''Forces changes to be written to disk. Returns a success code.'''
 *         cdef bint success = tctdbsync(self._state)
 *         return success             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyBool_FromLong(__pyx_v_success); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 342; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static Py_ssize_t __pyx_pf_8ctctable_7TCTable___len__(PyObject *__pyx_v_self) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":345
 * 
 *     def __len__(self):
 *         return tctdbrnum(self._state)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = PyObject_GetAttr(((PyObject *)__pyx_v_kwargs), __pyx_n_s__pop); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 348; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_3 = PyObject_GetAttr(((PyObject *)__pyx_v_kwargs), __pyx_n_s__pop); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 349; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  __pyx_t_7 = __Pyx_PyInt_AsInt(__pyx_v_limit); if (unlikely((__pyx_t_7 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 353; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_8 = __Pyx_PyInt_AsInt(__pyx_v_offset); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 353; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* "/usr/local/src/tctable/src/ctctable.pyx":355
 *         tctdbqrysetlimit(query_state, <int>limit, <int>offset)
 * 
 *     cdef void _set_order(TCTable self, TDBQRY* query_state, dict kwargs):             # <<<<<<<<<<<<<<
 ...
 */
  if (unlikely(((PyObject *)__pyx_v_kwargs) == Py_None)) {
    ...
    __pyx_t_1 = ((PyDict_Contains(((PyObject *)__pyx_v_kwargs), ((PyObject *)__pyx_n_s__order)))); if (unlikely(__pyx_t_1 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 356; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_2 = (!__pyx_t_1);
  if (__pyx_t_2) {
    goto __pyx_L0;
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":359
 *         # TODO: handle nums. NUMASC, NUMDESC how?
 *         #"order='+name' or order='-name'
 *         col = kwargs['order']             # <<<<<<<<<<<<<<
 *         if col[0] not in ('+', '-'):
 ...
 */
  __pyx_t_3 = PyObject_GetItem(((PyObject *)__pyx_v_kwargs), ((PyObject *)__pyx_n_s__order)); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 359; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_v_col);
  __pyx_v_col = __pyx_t_3;
  __pyx_t_3 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":360
 *         #"order='+name' or order='-name'
 *         col = kwargs['order']
 *         if col[0] not in ('+', '-'):             # <<<<<<<<<<<<<<
 *             direction = TDBQOSTRASC
 *         else:
 */
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_col, 0, sizeof(long), PyInt_FromLong); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 360; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = PyObject_RichCompare(__pyx_t_3, ((PyObject *)__pyx_kp_s_18), Py_NE); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 360; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyObject_IsTrue(__pyx_t_4); if (unlikely((__pyx_t_2 == (int)-1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 360; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_1 = ((int)__pyx_t_2);
  if (__pyx_t_1) {
    __pyx_t_4 = PyObject_RichCompare(__pyx_t_3, ((PyObject *)__pyx_kp_s_19), Py_NE); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 360; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_2 = __Pyx_PyObject_IsTrue(__pyx_t_4); if (unlikely((__pyx_t_2 == (int)-1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 360; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  if (__pyx_t_1) {
    ...
    /* "/usr/local/src/tctable/src/ctctable.pyx":361
 *         col = kwargs['order']
 *         if col[0] not in ('+', '-'):
 *             direction = TDBQOSTRASC             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    __pyx_t_3 = PyInt_FromLong(TDBQOSTRASC); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 361; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
  ...
  /*else*/ {
    ...
    /* "/usr/local/src/tctable/src/ctctable.pyx":363
 *             direction = TDBQOSTRASC
 *         else:
 *             direction = TDBQOSTRASC if col[0] == '+' else TDBQOSTRDESC             # <<<<<<<<<<<<<<
 *             col = col[1:]
 ...
 */
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_col, 0, sizeof(long), PyInt_FromLong); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 363; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = PyObject_RichCompare(__pyx_t_3, ((PyObject *)__pyx_kp_s_18), Py_EQ); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 363; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    __pyx_t_4 = PyInt_FromLong(__pyx_t_6); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 363; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_v_direction);
    __pyx_v_direction = __pyx_t_4;
    __pyx_t_4 = 0;

    /* "/usr/local/src/tctable/src/ctctable.pyx":364
 *         else:
 *             direction = TDBQOSTRASC if col[0] == '+' else TDBQOSTRDESC
 *             col = col[1:]             # <<<<<<<<<<<<<<
 *         tctdbqrysetorder(query_state, col, direction)
 * 
 */
    __pyx_t_4 = PySequence_GetSlice(__pyx_v_col, 1, PY_SSIZE_T_MAX); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 364; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_v_col);
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":365
 *             direction = TDBQOSTRASC if col[0] == '+' else TDBQOSTRDESC
 *             col = col[1:]
 *         tctdbqrysetorder(query_state, col, direction)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_7 = __Pyx_PyBytes_AsString(__pyx_v_col); if (unlikely((!__pyx_t_7) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 365; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_8 = __Pyx_PyInt_AsInt(__pyx_v_direction); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 365; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* "/usr/local/src/tctable/src/ctctable.pyx":367
 *         tctdbqrysetorder(query_state, col, direction)
 * 
 *     def count(self, *args, **kwargs):             # <<<<<<<<<<<<<<
 *         kwargs['count'] = True
...
static PyObject *__pyx_pf_8ctctable_7TCTable_count(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":368
 * 
 *     def count(self, *args, **kwargs):
 *         kwargs['count'] = True             # <<<<<<<<<<<<<<
 *         return self.select(*args, **kwargs)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetItem(__pyx_v_kwargs, ((PyObject *)__pyx_n_s__count), __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 368; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":369
 *     def count(self, *args, **kwargs):
 *         kwargs['count'] = True
 *         return self.select(*args, **kwargs)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s__select); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 369; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PySequence_Tuple(__pyx_v_args); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 369; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(((PyObject *)__pyx_t_2));
  __pyx_t_3 = PyEval_CallObjectWithKeywords(__pyx_t_1, ((PyObject *)__pyx_t_2), __pyx_v_kwargs); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 369; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
...
/* "/usr/local/src/tctable/src/ctctable.pyx":371
 *         return self.select(*args, **kwargs)
 * 
 *     def delete(self, *args, **kwargs):             # <<<<<<<<<<<<<<
 *         kwargs['delete'] = True
...
static PyObject *__pyx_pf_8ctctable_7TCTable_delete(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":372
 * 
 *     def delete(self, *args, **kwargs):
 *         kwargs['delete'] = True             # <<<<<<<<<<<<<<
 *         return self.select(*args, **kwargs)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetItem(__pyx_v_kwargs, ((PyObject *)__pyx_n_s__delete), __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 372; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s__select); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 373; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PySequence_Tuple(__pyx_v_args); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 373; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(((PyObject *)__pyx_t_2));
  __pyx_t_3 = PyEval_CallObjectWithKeywords(__pyx_t_1, ((PyObject *)__pyx_t_2), __pyx_v_kwargs); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 373; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_2)); __pyx_t_2 = 0;
  __pyx_r = __pyx_t_3;
...
static PyObject *__pyx_pf_8ctctable_7TCTable_select(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, __pyx_v_kwargs, values, 0, "select") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 375; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    if (values[0]) {
      __pyx_v_values_only = __Pyx_PyObject_IsTrue(values[0]); if (unlikely((__pyx_v_values_only == (int)-1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 375; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("select", 0, 0, 0, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 375; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_DECREF(__pyx_v_args);
  __Pyx_DECREF(__pyx_v_kwargs);
 ...
 *         cdef TCLIST *tclist
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_8ctctable_make_query(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->_state)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 379; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":389
 *         # tbl.select(name='fred', age=22)
 ...
 */
  ...
  __pyx_t_2 = PyObject_Call(((PyObject *)((PyObject*)&PyList_Type)), __pyx_t_1, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 389; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_v_args);
 ...
 */
  __pyx_t_2 = PyObject_GetAttr(__pyx_v_kwargs, __pyx_n_s__items); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 390; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  for (;;) {
    ...
    if (PyTuple_CheckExact(__pyx_t_1) && likely(PyTuple_GET_SIZE(__pyx_t_1) == 2)) {
      ...
      __pyx_t_6 = PyObject_GetIter(__pyx_t_1); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 390; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_4 = __Pyx_UnpackItem(__pyx_t_6, 0); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 390; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      ...
      __Pyx_GOTREF(__pyx_t_5);
      if (__Pyx_EndUnpack(__pyx_t_6) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 390; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_DECREF(__pyx_v_colname);
      __pyx_v_colname = __pyx_t_4;
      __pyx_t_4 = 0;
 ...
 * 
 */
    __pyx_t_7 = ((PySequence_Contains(__pyx_v_kwskip, __pyx_v_colname))); if (unlikely(__pyx_t_7 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 391; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (__pyx_t_7) {
 ...
 */
    ...
    __pyx_t_5 = PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_8ctctable_Col)), __pyx_t_1, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 392; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = PyObject_RichCompare(__pyx_t_5, __pyx_v_other, Py_EQ); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 392; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyObject_Append(__pyx_v_args, __pyx_t_1); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 392; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_L6_continue:;
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":394
 *             args.append(Col(colname) == other)
 * 
 *         for col in args:             # <<<<<<<<<<<<<<
 ...
 */
  if (PyList_CheckExact(__pyx_v_args) || PyTuple_CheckExact(__pyx_v_args)) {
    ...
    __pyx_t_3 = -1; __pyx_t_2 = PyObject_GetIter(__pyx_v_args); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 394; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
  }
  for (;;) {
    if (likely(PyList_CheckExact(__pyx_t_2))) {
    ...
    /* "/usr/local/src/tctable/src/ctctable.pyx":397
 *             # separate these out rather than |'ing here because
 *             # they may reuse the Col object.
 *             if col.invert:             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_5 = PyObject_GetAttr(__pyx_v_col, __pyx_n_s__invert); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 397; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_7 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely(__pyx_t_7 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 397; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    if (__pyx_t_7) {

      /* "/usr/local/src/tctable/src/ctctable.pyx":398
 *             # they may reuse the Col object.
 *             if col.invert:
 *                 tctdbqryaddcond(q._state, <char *>col.colname,             # <<<<<<<<<<<<<<
 *                                 <int>(col.op | TDBQCNEGATE), <char *>col.other)
 *             else:
 */
      __pyx_t_5 = PyObject_GetAttr(__pyx_v_col, __pyx_n_s__colname); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 398; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_8 = __Pyx_PyBytes_AsString(__pyx_t_5); if (unlikely((!__pyx_t_8) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 398; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

      /* "/usr/local/src/tctable/src/ctctable.pyx":399
 *             if col.invert:
 *                 tctdbqryaddcond(q._state, <char *>col.colname,
 *                                 <int>(col.op | TDBQCNEGATE), <char *>col.other)             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      __pyx_t_5 = PyObject_GetAttr(__pyx_v_col, __pyx_n_s__op); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 399; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_1 = PyInt_FromLong(TDBQCNEGATE); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 399; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_4 = PyNumber_Or(__pyx_t_5, __pyx_t_1); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 399; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_9 = __Pyx_PyInt_AsInt(__pyx_t_4); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 399; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_4 = PyObject_GetAttr(__pyx_v_col, __pyx_n_s__other); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 399; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_10 = __Pyx_PyBytes_AsString(__pyx_t_4); if (unlikely((!__pyx_t_10) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 399; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    /*else*/ {
      ...
      /* "/usr/local/src/tctable/src/ctctable.pyx":401
 *                                 <int>(col.op | TDBQCNEGATE), <char *>col.other)
 *             else:
 *                 tctdbqryaddcond(q._state, <char *>col.colname, <int>col.op,             # <<<<<<<<<<<<<<
 *                                 <char *>col.other)
 * 
 */
      __pyx_t_4 = PyObject_GetAttr(__pyx_v_col, __pyx_n_s__colname); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 401; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_10 = __Pyx_PyBytes_AsString(__pyx_t_4); if (unlikely((!__pyx_t_10) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 401; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_4 = PyObject_GetAttr(__pyx_v_col, __pyx_n_s__op); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 401; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_9 = __Pyx_PyInt_AsInt(__pyx_t_4); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 401; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

      /* "/usr/local/src/tctable/src/ctctable.pyx":402
 *             else:
 *                 tctdbqryaddcond(q._state, <char *>col.colname, <int>col.op,
 *                                 <char *>col.other)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_4 = PyObject_GetAttr(__pyx_v_col, __pyx_n_s__other); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 402; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_8 = __Pyx_PyBytes_AsString(__pyx_t_4); if (unlikely((!__pyx_t_8) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 402; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 * 
 */
  if (!(likely(PyDict_CheckExact(__pyx_v_kwargs))||((__pyx_v_kwargs) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected dict, got %.200s", Py_TYPE(__pyx_v_kwargs)->tp_name), 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 404; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         if 'delete' in kwargs:
 */
  if (!(likely(PyDict_CheckExact(__pyx_v_kwargs))||((__pyx_v_kwargs) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected dict, got %.200s", Py_TYPE(__pyx_v_kwargs)->tp_name), 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 405; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_t_7 = ((PySequence_Contains(__pyx_v_kwargs, ((PyObject *)__pyx_n_s__delete)))); if (unlikely(__pyx_t_7 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 407; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__pyx_t_7) {
 ...
 */
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_2 = __Pyx_PyBool_FromLong(tctdbqrysearchout(__pyx_v_q->_state)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 408; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_r = __pyx_t_2;
    __pyx_t_2 = 0;
    goto __pyx_L0;
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":412
 *         tclist = tctdbqrysearch(q._state)
 *         # number of elements in the list
 *         count = tclistnum(tclist)             # <<<<<<<<<<<<<<
 * 
 ...
 *             return count
 */
  __pyx_t_7 = ((PySequence_Contains(__pyx_v_kwargs, ((PyObject *)__pyx_n_s__count)))); if (unlikely(__pyx_t_7 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 414; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__pyx_t_7) {

    /* "/usr/local/src/tctable/src/ctctable.pyx":415
 * 
 *         if 'count' in kwargs:
 *             tclistdel(tclist)             # <<<<<<<<<<<<<<
 *             return count
 ...
 *         return li
 */
  __pyx_t_2 = ((PyObject *)((struct __pyx_vtabstruct_8ctctable_TCTable *)((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self)->__pyx_vtab)->_tclist_to_list(((struct __pyx_obj_8ctctable_TCTable *)__pyx_v_self), __pyx_v_tclist, __pyx_v_count, __pyx_v_values_only)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 418; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(((PyObject *)__pyx_v_li));
  __pyx_v_li = ((PyObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":419
 * 
 *         li = self._tclist_to_list(tclist, count, values_only)
 *         tclistdel(tclist)             # <<<<<<<<<<<<<<
 *         return li
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":420
 *         li = self._tclist_to_list(tclist, count, values_only)
 *         tclistdel(tclist)
 *         return li             # <<<<<<<<<<<<<<
 * 
 ...
 *                 li.append(d)
 */
    __pyx_t_1 = ((PyObject *)((struct __pyx_vtabstruct_8ctctable_TCTable *)__pyx_v_self->__pyx_vtab)->_ckey_to_dict(__pyx_v_self, __pyx_v_kbuf, __pyx_v_ksiz)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 433; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "/usr/local/src/tctable/src/ctctable.pyx":435
 *             d = self._ckey_to_dict(kbuf, ksiz)
 *             if values_only:
 *                 li.append(d)             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      __pyx_t_5 = PyList_Append(((PyObject *)__pyx_v_li), ((PyObject *)__pyx_v_d)); if (unlikely(__pyx_t_5 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 435; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      goto __pyx_L5;
    }
    /*else*/ {

      /* "/usr/local/src/tctable/src/ctctable.pyx":437
 *                 li.append(d)
 *             else:
 *                 key = ps.PyString_FromStringAndSize(kbuf, <Py_ssize_t>ksiz)             # <<<<<<<<<<<<<<
 *                 li.append((key, d))
 *         return li
 */
      __pyx_t_1 = PyString_FromStringAndSize(__pyx_v_kbuf, ((Py_ssize_t)__pyx_v_ksiz)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 437; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_v_key);
 ...
 */
      ...
      __Pyx_GIVEREF(((PyObject *)__pyx_v_d));
      __pyx_t_5 = PyList_Append(((PyObject *)__pyx_v_li), __pyx_t_1); if (unlikely(__pyx_t_5 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 438; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    }
    __pyx_L5:;
  }
...
/* "/usr/local/src/tctable/src/ctctable.pyx":454
...
static int __pyx_pf_8ctctable_3Col___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "__cinit__") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 454; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 1, 1, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 454; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("ctctable.Col.__cinit__");
  return -1;
  __pyx_L4_argument_unpacking_done:;

  /* "/usr/local/src/tctable/src/ctctable.pyx":455
 * 
 *     def __cinit__(self, colname):
 *         self.invert = False             # <<<<<<<<<<<<<<
 *         self.num_lookups= {
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":456
 *     def __cinit__(self, colname):
 *         self.invert = False
 *         self.num_lookups= {             # <<<<<<<<<<<<<<
 *                 0: TDBQCNUMLT, # <
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":457
 *         self.invert = False
 *         self.num_lookups= {
 *                 0: TDBQCNUMLT, # <             # <<<<<<<<<<<<<<
 *                 1: TDBQCNUMLE, # <=
 *                 2: TDBQCNUMEQ, # ==
 */
  __pyx_t_2 = PyInt_FromLong(TDBQCNUMLT); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 457; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_0, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 456; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":458
 *         self.num_lookups= {
 *                 0: TDBQCNUMLT, # <
 *                 1: TDBQCNUMLE, # <=             # <<<<<<<<<<<<<<
 *                 2: TDBQCNUMEQ, # ==
 ...
 */
  __pyx_t_2 = PyInt_FromLong(TDBQCNUMLE); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 458; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_1, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 456; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":459
 *                 0: TDBQCNUMLT, # <
 *                 1: TDBQCNUMLE, # <=
 *                 2: TDBQCNUMEQ, # ==             # <<<<<<<<<<<<<<
 *                 3: TDBQCNUMEQ | TDBQCNEGATE, # !=. # TODO test.
 *                 4: TDBQCNUMGT, # >
 */
  __pyx_t_2 = PyInt_FromLong(TDBQCNUMEQ); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 459; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_2, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 456; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":460
 *                 1: TDBQCNUMLE, # <=
 *                 2: TDBQCNUMEQ, # ==
 *                 3: TDBQCNUMEQ | TDBQCNEGATE, # !=. # TODO test.             # <<<<<<<<<<<<<<
 *                 4: TDBQCNUMGT, # >
 *                 5: TDBQCNUMGE  # >=
 */
  __pyx_t_2 = PyInt_FromLong((TDBQCNUMEQ | TDBQCNEGATE)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 460; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_3, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 456; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":461
 *                 2: TDBQCNUMEQ, # ==
 *                 3: TDBQCNUMEQ | TDBQCNEGATE, # !=. # TODO test.
 *                 4: TDBQCNUMGT, # >             # <<<<<<<<<<<<<<
 *                 5: TDBQCNUMGE  # >=
 *             }
 */
  __pyx_t_2 = PyInt_FromLong(TDBQCNUMGT); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 461; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_4, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 456; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":463
 *                 4: TDBQCNUMGT, # >
 *                 5: TDBQCNUMGE  # >=
 *             }             # <<<<<<<<<<<<<<
 ...
 *     """
 */
  __pyx_t_2 = PyInt_FromLong(TDBQCNUMGE); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 463; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_5, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 456; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":464
 *                 5: TDBQCNUMGE  # >=
 *             }
 *         self.colname = colname             # <<<<<<<<<<<<<<
 *     """
...
/* "/usr/local/src/tctable/src/ctctable.pyx":480
...
static PyObject *__pyx_pf_8ctctable_3Col___richcmp__(PyObject *__pyx_v_self, PyObject *__pyx_v_other, int __pyx_arg_op) {
  ...
  __pyx_v_op = PyInt_FromLong(__pyx_arg_op); if (unlikely(!__pyx_v_op)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 480; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":481
 *     # < 0 | <= 1 | == 2 | != 3 |  > 4 | >= 5
 *     def __richcmp__(self, other, op):
 *         self.other = unicode(other)             # <<<<<<<<<<<<<<
 *         if isinstance(other, (int, long, float)):
 ...
 */
  ...
  __pyx_t_2 = PyObject_Call(((PyObject *)((PyObject*)&PyUnicode_Type)), __pyx_t_1, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 481; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyObject_SetAttr(__pyx_v_self, __pyx_n_s__other, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 481; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":482
 *     def __richcmp__(self, other, op):
 *         self.other = unicode(other)
 *         if isinstance(other, (int, long, float)):             # <<<<<<<<<<<<<<
 *             self.op = self.num_lookups[op]
 ...
 */
  ...
  __pyx_t_3 = PyObject_IsInstance(__pyx_v_other, __pyx_t_2); if (unlikely(__pyx_t_3 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 482; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (__pyx_t_3) {

    /* "/usr/local/src/tctable/src/ctctable.pyx":483
 *         self.other = unicode(other)
 *         if isinstance(other, (int, long, float)):
 *             self.op = self.num_lookups[op]             # <<<<<<<<<<<<<<
 *         else:
 *             str_lookups= {
 */
    __pyx_t_2 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s__num_lookups); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 483; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = PyObject_GetItem(__pyx_t_2, __pyx_v_op); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 483; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    if (PyObject_SetAttr(__pyx_v_self, __pyx_n_s__op, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 483; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    goto __pyx_L5;
  }
  /*else*/ {

    /* "/usr/local/src/tctable/src/ctctable.pyx":485
 *             self.op = self.num_lookups[op]
 *         else:
 *             str_lookups= {             # <<<<<<<<<<<<<<
 *                 2: TDBQCSTREQ, # ==
 ...
 */
    ...
    /* "/usr/local/src/tctable/src/ctctable.pyx":486
 *         else:
 *             str_lookups= {
 *                 2: TDBQCSTREQ, # ==             # <<<<<<<<<<<<<<
 *                 3: TDBQCSTREQ | TDBQCNEGATE # not equal.
 *             }
 */
    __pyx_t_2 = PyInt_FromLong(TDBQCSTREQ); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 486; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    if (PyDict_SetItem(__pyx_t_1, __pyx_int_2, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 485; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

    /* "/usr/local/src/tctable/src/ctctable.pyx":488
 *                 2: TDBQCSTREQ, # ==
 *                 3: TDBQCSTREQ | TDBQCNEGATE # not equal.
 *             }             # <<<<<<<<<<<<<<
 ...
 *         return self
 */
    __pyx_t_2 = PyInt_FromLong((TDBQCSTREQ | TDBQCNEGATE)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 487; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    if (PyDict_SetItem(__pyx_t_1, __pyx_int_3, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 485; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_v_str_lookups);
    __pyx_v_str_lookups = ((PyObject *)__pyx_t_1);
    __pyx_t_1 = 0;

    /* "/usr/local/src/tctable/src/ctctable.pyx":489
 *                 3: TDBQCSTREQ | TDBQCNEGATE # not equal.
 *             }
 *             self.op = str_lookups[op]             # <<<<<<<<<<<<<<
 *         return self
 * 
 */
    __pyx_t_1 = PyObject_GetItem(__pyx_v_str_lookups, __pyx_v_op); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 489; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    if (PyObject_SetAttr(__pyx_v_self, __pyx_n_s__op, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 489; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  }
  __pyx_L5:;

  /* "/usr/local/src/tctable/src/ctctable.pyx":490
 *             }
 *             self.op = str_lookups[op]
 *         return self             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/local/src/tctable/src/ctctable.pyx":492
 *         return self
 * 
 *     def __invert__(self):             # <<<<<<<<<<<<<<
 *         # ~Col('age') == 180
...
static PyObject *__pyx_pf_8ctctable_3Col___invert__(PyObject *__pyx_v_self) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":494
 *     def __invert__(self):
 *         # ~Col('age') == 180
 *         self.invert = not self.invert             # <<<<<<<<<<<<<<
 *         return self
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":495
 *         # ~Col('age') == 180
 *         self.invert = not self.invert
 *         return self             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/local/src/tctable/src/ctctable.pyx":497
 *         return self
 * 
 *     def matches(self, pattern):             # <<<<<<<<<<<<<<
 *         self.op = TDBQCSTRRX
...
static PyObject *__pyx_pf_8ctctable_3Col_matches(PyObject *__pyx_v_self, PyObject *__pyx_v_pattern) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":498
 * 
 *     def matches(self, pattern):
 *         self.op = TDBQCSTRRX             # <<<<<<<<<<<<<<
 *         self.other = pattern
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":499
 *     def matches(self, pattern):
 *         self.op = TDBQCSTRRX
 *         self.other = pattern             # <<<<<<<<<<<<<<
 *         return self
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":500
 *         self.op = TDBQCSTRRX
 *         self.other = pattern
 *         return self             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/local/src/tctable/src/ctctable.pyx":502
 *         return self
 * 
 *     def in_list(self, li):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_8ctctable_3Col_in_list(PyObject *__pyx_v_self, PyObject *__pyx_v_li); /*proto*/
static PyObject *__pyx_pf_8ctctable_3Col_in_list(PyObject *__pyx_v_self, PyObject *__pyx_v_li) {
  PyObject *__pyx_r = NULL;
  PyObject *__pyx_t_1 = NULL;
  int __pyx_t_2;
  int __pyx_t_3;
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":503
 * 
 *     def in_list(self, li):
 *         if isinstance(li[0], basestring):             # <<<<<<<<<<<<<<
 *             self.op = TDBQCSTROREQ if len(li) > 1 else TDBQCSTREQ
 *         else:
 */
  __pyx_t_1 = __Pyx_GetItemInt(__pyx_v_li, 0, sizeof(long), PyInt_FromLong); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 503; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyObject_IsInstance(__pyx_t_1, __pyx_builtin_basestring); if (unlikely(__pyx_t_2 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 503; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (__pyx_t_2) {

    /* "/usr/local/src/tctable/src/ctctable.pyx":504
 *     def in_list(self, li):
 *         if isinstance(li[0], basestring):
 *             self.op = TDBQCSTROREQ if len(li) > 1 else TDBQCSTREQ             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    __pyx_t_4 = PyObject_Length(__pyx_v_li); if (unlikely(__pyx_t_4 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 504; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if ((__pyx_t_4 > 1)) {
      __pyx_t_3 = TDBQCSTROREQ;
    } else {
      __pyx_t_3 = TDBQCSTREQ;
    }
    ((struct __pyx_obj_8ctctable_Col *)__pyx_v_self)->op = __pyx_t_3;
    goto __pyx_L5;
  }
  /*else*/ {

    /* "/usr/local/src/tctable/src/ctctable.pyx":506
 *             self.op = TDBQCSTROREQ if len(li) > 1 else TDBQCSTREQ
 *         else:
 *             self.op = TDBQCNUMOREQ if len(li) > 1 else TDBQCNUMEQ             # <<<<<<<<<<<<<<
 *             li = map(str, li)
 *         self.other = ' '.join(li)
 */
    __pyx_t_4 = PyObject_Length(__pyx_v_li); if (unlikely(__pyx_t_4 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 506; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if ((__pyx_t_4 > 1)) {
    ...
    /* "/usr/local/src/tctable/src/ctctable.pyx":507
 *         else:
 *             self.op = TDBQCNUMOREQ if len(li) > 1 else TDBQCNUMEQ
 *             li = map(str, li)             # <<<<<<<<<<<<<<
 *         self.other = ' '.join(li)
 ...
 */
    ...
    __pyx_t_5 = PyObject_Call(__pyx_builtin_map, __pyx_t_1, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 507; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":508
 *             self.op = TDBQCNUMOREQ if len(li) > 1 else TDBQCNUMEQ
 *             li = map(str, li)
 *         self.other = ' '.join(li)             # <<<<<<<<<<<<<<
 *         return self
 * 
 */
  __pyx_t_5 = PyObject_GetAttr(((PyObject *)__pyx_kp_s_11), __pyx_n_s__join); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 508; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GIVEREF(__pyx_v_li);
  __pyx_t_6 = PyObject_Call(__pyx_t_5, __pyx_t_1, NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 508; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_GIVEREF(__pyx_t_6);
  __Pyx_GOTREF(((struct __pyx_obj_8ctctable_Col *)__pyx_v_self)->other);
  __Pyx_DECREF(((struct __pyx_obj_8ctctable_Col *)__pyx_v_self)->other);
  ((struct __pyx_obj_8ctctable_Col *)__pyx_v_self)->other = __pyx_t_6;
  __pyx_t_6 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":509
 *             li = map(str, li)
 *         self.other = ' '.join(li)
 *         return self             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_5);
  __Pyx_XDECREF(__pyx_t_6);
  __Pyx_AddTraceback("ctctable.Col.in_list");
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_DECREF((PyObject *)__pyx_v_self);
  __Pyx_DECREF(__pyx_v_li);
...
/* "/usr/local/src/tctable/src/ctctable.pyx":511
 *         return self
 * 
 *     def like(self, other):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_8ctctable_3Col_like(PyObject *__pyx_v_self, PyObject *__pyx_v_other); /*proto*/
static PyObject *__pyx_pf_8ctctable_3Col_like(PyObject *__pyx_v_self, PyObject *__pyx_v_other) {
  PyObject *__pyx_r = NULL;
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("like");

  /* "/usr/local/src/tctable/src/ctctable.pyx":512
 * 
 *     def like(self, other):
 *         assert isinstance(other, basestring)             # <<<<<<<<<<<<<<
 *         self.op = TDBQCSTRINC
 ...
 */
  ...
  __pyx_t_1 = PyObject_IsInstance(__pyx_v_other, __pyx_builtin_basestring); if (unlikely(__pyx_t_1 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 512; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":513
 *     def like(self, other):
 *         assert isinstance(other, basestring)
 *         self.op = TDBQCSTRINC             # <<<<<<<<<<<<<<
 *         self.other = other
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":514
 *         assert isinstance(other, basestring)
 *         self.op = TDBQCSTRINC
 *         self.other = other             # <<<<<<<<<<<<<<
 *         return self
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":515
 *         self.op = TDBQCSTRINC
 *         self.other = other
 *         return self             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("ctctable.Col.like");
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* "/usr/local/src/tctable/src/ctctable.pyx":517
 *         return self
 * 
 *     def startswith(self, other):             # <<<<<<<<<<<<<<
 *         self.other = other
...
static PyObject *__pyx_pf_8ctctable_3Col_startswith(PyObject *__pyx_v_self, PyObject *__pyx_v_other) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":518
 * 
 *     def startswith(self, other):
 *         self.other = other             # <<<<<<<<<<<<<<
 *         self.op = TDBQCSTRBW
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":519
 *     def startswith(self, other):
 *         self.other = other
 *         self.op = TDBQCSTRBW             # <<<<<<<<<<<<<<
 *         return self
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":520
 *         self.other = other
 *         self.op = TDBQCSTRBW
 *         return self             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/local/src/tctable/src/ctctable.pyx":522
 *         return self
 * 
 *     def endswith(self, other):             # <<<<<<<<<<<<<<
 *         self.other = other
...
static PyObject *__pyx_pf_8ctctable_3Col_endswith(PyObject *__pyx_v_self, PyObject *__pyx_v_other) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":523
 * 
 *     def endswith(self, other):
 *         self.other = other             # <<<<<<<<<<<<<<
 *         self.op = TDBQCSTREW
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":524
 *     def endswith(self, other):
 *         self.other = other
 *         self.op = TDBQCSTREW             # <<<<<<<<<<<<<<
 *         return self
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":525
 *         self.other = other
 *         self.op = TDBQCSTREW
 *         return self             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/local/src/tctable/src/ctctable.pyx":527
 *         return self
 * 
 *     def between(self, low, high):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_8ctctable_3Col_between(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("between", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 527; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "between") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 527; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("between", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 527; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("ctctable.Col.between");
  return NULL;
  __pyx_L4_argument_unpacking_done:;

  /* "/usr/local/src/tctable/src/ctctable.pyx":528
 * 
 *     def between(self, low, high):
 *         self.other = str(low) + ' ' + str(high)             # <<<<<<<<<<<<<<
 *         self.op = TDBQCNUMBT
 ...
 */
  ...
  __pyx_t_2 = PyObject_Call(((PyObject *)((PyObject*)&PyString_Type)), __pyx_t_1, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 528; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyNumber_Add(__pyx_t_2, ((PyObject *)__pyx_kp_s_11)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 528; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyNumber_Add(__pyx_t_1, __pyx_t_3); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 528; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_GIVEREF(__pyx_t_2);
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":529
 *     def between(self, low, high):
 *         self.other = str(low) + ' ' + str(high)
 *         self.op = TDBQCNUMBT             # <<<<<<<<<<<<<<
 *         return self
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":530
 *         self.other = str(low) + ' ' + str(high)
 *         self.op = TDBQCNUMBT
 *         return self             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/local/src/tctable/src/ctctable.pyx":535
 * cdef class TCMap(object):
 *     cdef TCMAP* _state
 *     def __del__(self):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_8ctctable_5TCMap___del__(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":536
 *     cdef TCMAP* _state
 *     def __del__(self):
 *         tcmapdel(self._state)             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/local/src/tctable/src/ctctable.pyx":538
 *         tcmapdel(self._state)
 * 
 * cdef TCMap make_tcmap():             # <<<<<<<<<<<<<<
 *     pass
...
static  struct __pyx_obj_8ctctable_TCMap *__pyx_f_8ctctable_make_tcmap(void) {
  ...
  __pyx_r = ((struct __pyx_obj_8ctctable_TCMap *)Py_None); __Pyx_INCREF(Py_None);
  __Pyx_XGIVEREF((PyObject *)__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "/usr/local/src/tctable/src/ctctable.pyx":545
 * cdef class TCQuery(object):
 *     cdef TDBQRY* _state
 *     def __dealloc__(self):             # <<<<<<<<<<<<<<
...
static void __pyx_pf_8ctctable_7TCQuery___dealloc__(PyObject *__pyx_v_self) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":546
 *     cdef TDBQRY* _state
 *     def __dealloc__(self):
 *         tctdbqrydel(self._state)             # <<<<<<<<<<<<<<
 * 
...
/* "/usr/local/src/tctable/src/ctctable.pyx":548
 *         tctdbqrydel(self._state)
 * 
 * cdef TCQuery make_query(TCTDB* tctdb):             # <<<<<<<<<<<<<<
...
static  struct __pyx_obj_8ctctable_TCQuery *__pyx_f_8ctctable_make_query(TCTDB *__pyx_v_tctdb) {
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":549
 * 
 * cdef TCQuery make_query(TCTDB* tctdb):
 *     cdef TCQuery query = TCQuery()             # <<<<<<<<<<<<<<
 *     query._state = tctdbqrynew(tctdb)
 *     return query
 */
  __pyx_t_1 = PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_8ctctable_TCQuery)), ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 549; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_query = ((struct __pyx_obj_8ctctable_TCQuery *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":550
 * cdef TCQuery make_query(TCTDB* tctdb):
 *     cdef TCQuery query = TCQuery()
 *     query._state = tctdbqrynew(tctdb)             # <<<<<<<<<<<<<<
 *     return query
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":551
 *     cdef TCQuery query = TCQuery()
 *     query._state = tctdbqrynew(tctdb)
 *     return query             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_tp_new_8ctctable_TCTable(PyTypeObject *t, PyObject *a, PyObject *k) {
  ...
  if (__pyx_pf_8ctctable_7TCTable___cinit__(o, a, k) < 0) {
    Py_DECREF(o); o = 0;
  }
  return o;
}
...
static struct PyMethodDef __pyx_methods_8ctctable_TCTable[] = {
  ...
  {__Pyx_NAMESTR("_msg"), (PyCFunction)__pyx_pf_8ctctable_7TCTable__msg, METH_NOARGS, __Pyx_DOCSTR(__pyx_doc_8ctctable_7TCTable__msg)},
  {__Pyx_NAMESTR("optimize"), (PyCFunction)__pyx_pf_8ctctable_7TCTable_optimize, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  ...
  {__Pyx_NAMESTR("optimize_index"), (PyCFunction)__pyx_pf_8ctctable_7TCTable_optimize_index, METH_O, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("delete_index"), (PyCFunction)__pyx_pf_8ctctable_7TCTable_delete_index, METH_O, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("create_index"), (PyCFunction)__pyx_pf_8ctctable_7TCTable_create_index, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_8ctctable_7TCTable_create_index)},
  {__Pyx_NAMESTR("put"), (PyCFunction)__pyx_pf_8ctctable_7TCTable_put, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_8ctctable_7TCTable_put)},
  {__Pyx_NAMESTR("__iter__"), (PyCFunction)__pyx_pf_8ctctable_7TCTable___iter__, METH_NOARGS|METH_COEXIST, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("__next__"), (PyCFunction)__pyx_pf_8ctctable_7TCTable___next__, METH_NOARGS|METH_COEXIST, __Pyx_DOCSTR(0)},
...
PyTypeObject __pyx_type_8ctctable_TCTable = {
  ...
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  __pyx_pf_8ctctable_7TCTable___iter__, /*tp_iter*/
  __pyx_pf_8ctctable_7TCTable___next__, /*tp_iternext*/
...
static PyObject *__pyx_tp_new_8ctctable_Col(PyTypeObject *t, PyObject *a, PyObject *k) {
  ...
  if (__pyx_pf_8ctctable_3Col___cinit__(o, a, k) < 0) {
    Py_DECREF(o); o = 0;
  }
  return o;
}
...
static struct PyMethodDef __pyx_methods_8ctctable_Col[] = {
  ...
  {__Pyx_NAMESTR("in_list"), (PyCFunction)__pyx_pf_8ctctable_3Col_in_list, METH_O, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("like"), (PyCFunction)__pyx_pf_8ctctable_3Col_like, METH_O, __Pyx_DOCSTR(0)},
...
static struct PyMemberDef __pyx_members_8ctctable_Col[] = {
  {(char *)"colname", T_OBJECT, offsetof(struct __pyx_obj_8ctctable_Col, colname), READONLY, 0},
  ...
  {(char *)"num_lookups", T_OBJECT, offsetof(struct __pyx_obj_8ctctable_Col, num_lookups), READONLY, 0},
  {(char *)"invert", T_INT, offsetof(struct __pyx_obj_8ctctable_Col, invert), READONLY, 0},
  {0, 0, 0, 0, 0}
};
...
static PyObject *__pyx_tp_new_8ctctable_TCMap(PyTypeObject *t, PyObject *a, PyObject *k) {
  PyObject *o = (*t->tp_alloc)(t, 0);
  if (!o) return 0;
  return o;
}

static void __pyx_tp_dealloc_8ctctable_TCMap(PyObject *o) {
  (*Py_TYPE(o)->tp_free)(o);
}

static struct PyMethodDef __pyx_methods_8ctctable_TCMap[] = {
  {__Pyx_NAMESTR("__del__"), (PyCFunction)__pyx_pf_8ctctable_5TCMap___del__, METH_NOARGS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
PyTypeObject __pyx_type_8ctctable_TCMap = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("ctctable.TCMap"), /*tp_name*/
  sizeof(struct __pyx_obj_8ctctable_TCMap), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_8ctctable_TCMap, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  0, /*tp_compare*/
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_8ctctable_TCMap, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_8ctctable_TCMap, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static void __pyx_tp_dealloc_8ctctable_TCQuery(PyObject *o) {
  {
    ...
    ++Py_REFCNT(o);
    __pyx_pf_8ctctable_7TCQuery___dealloc__(o);
...
static int __Pyx_InitCachedBuiltins(void) {
  ...
  __pyx_builtin_range = __Pyx_GetName(__pyx_b, __pyx_n_s__range); if (!__pyx_builtin_range) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 431; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_builtin_basestring = __Pyx_GetName(__pyx_b, __pyx_n_s__basestring); if (!__pyx_builtin_basestring) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 503; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_builtin_map = __Pyx_GetName(__pyx_b, __pyx_n_s__map); if (!__pyx_builtin_map) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 507; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  return 0;
  __pyx_L1_error:;
  return -1;
}
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("ctctable"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_20), 0, PYTHON_API_VERSION);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  __pyx_vtable_8ctctable_TCTable._msg = (PyObject *(*)(struct __pyx_obj_8ctctable_TCTable *, int __pyx_skip_dispatch))__pyx_f_8ctctable_7TCTable__msg;
  ...
  __pyx_vtable_8ctctable_TCTable.create_index = (int (*)(struct __pyx_obj_8ctctable_TCTable *, char *, PyObject *, int __pyx_skip_dispatch))__pyx_f_8ctctable_7TCTable_create_index;
  ...
  __pyx_vtable_8ctctable_TCTable._key_to_dict = (PyObject *(*)(struct __pyx_obj_8ctctable_TCTable *, PyObject *))__pyx_f_8ctctable_7TCTable__key_to_dict;
  __pyx_vtable_8ctctable_TCTable._ckey_to_dict = (PyObject *(*)(struct __pyx_obj_8ctctable_TCTable *, char *, int))__pyx_f_8ctctable_7TCTable__ckey_to_dict;
  __pyx_vtable_8ctctable_TCTable._put_keep_code = (PyObject *(*)(struct __pyx_obj_8ctctable_TCTable *, int, PyObject *))__pyx_f_8ctctable_7TCTable__put_keep_code;
  __pyx_vtable_8ctctable_TCTable.get = (PyObject *(*)(struct __pyx_obj_8ctctable_TCTable *, PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_8ctctable_7TCTable_get *__pyx_optional_args))__pyx_f_8ctctable_7TCTable_get;
  ...
  __pyx_vtable_8ctctable_TCTable._tclist_to_list = (PyObject *(*)(struct __pyx_obj_8ctctable_TCTable *, TCLIST *, int, int))__pyx_f_8ctctable_7TCTable__tclist_to_list;
  #else
  *(void(**)(void))&__pyx_vtable_8ctctable_TCTable._msg = (void(*)(void))__pyx_f_8ctctable_7TCTable__msg;
  *(void(**)(void))&__pyx_vtable_8ctctable_TCTable._dict_to_tcmap = (void(*)(void))__pyx_f_8ctctable_7TCTable__dict_to_tcmap;
  *(void(**)(void))&__pyx_vtable_8ctctable_TCTable.create_index = (void(*)(void))__pyx_f_8ctctable_7TCTable_create_index;
  *(void(**)(void))&__pyx_vtable_8ctctable_TCTable._tcmap_to_dict = (void(*)(void))__pyx_f_8ctctable_7TCTable__tcmap_to_dict;
  *(void(**)(void))&__pyx_vtable_8ctctable_TCTable._key_to_dict = (void(*)(void))__pyx_f_8ctctable_7TCTable__key_to_dict;
  *(void(**)(void))&__pyx_vtable_8ctctable_TCTable._ckey_to_dict = (void(*)(void))__pyx_f_8ctctable_7TCTable__ckey_to_dict;
  *(void(**)(void))&__pyx_vtable_8ctctable_TCTable._put_keep_code = (void(*)(void))__pyx_f_8ctctable_7TCTable__put_keep_code;
  *(void(**)(void))&__pyx_vtable_8ctctable_TCTable.get = (void(*)(void))__pyx_f_8ctctable_7TCTable_get;
  ...
  *(void(**)(void))&__pyx_vtable_8ctctable_TCTable._tclist_to_list = (void(*)(void))__pyx_f_8ctctable_7TCTable__tclist_to_list;
  #endif
  if (PyType_Ready(&__pyx_type_8ctctable_TCTable) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetVtable(__pyx_type_8ctctable_TCTable.tp_dict, __pyx_vtabptr_8ctctable_TCTable) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "TCTable", (PyObject *)&__pyx_type_8ctctable_TCTable) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_8ctctable_TCTable = &__pyx_type_8ctctable_TCTable;
  if (PyType_Ready(&__pyx_type_8ctctable_Col) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 441; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "Col", (PyObject *)&__pyx_type_8ctctable_Col) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 441; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_8ctctable_Col = &__pyx_type_8ctctable_Col;
  if (PyType_Ready(&__pyx_type_8ctctable_TCMap) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 533; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "TCMap", (PyObject *)&__pyx_type_8ctctable_TCMap) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 533; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_8ctctable_TCMap = &__pyx_type_8ctctable_TCMap;
  if (PyType_Ready(&__pyx_type_8ctctable_TCQuery) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 543; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "TCQuery", (PyObject *)&__pyx_type_8ctctable_TCQuery) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 543; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_8ctctable_TCQuery = &__pyx_type_8ctctable_TCQuery;
  /*--- Type import code ---*/
  /*--- Function import code ---*/
  /*--- Execution code ---*/

  /* "/usr/local/src/tctable/src/ctctable.pyx":24
 * 
 * DEF DEFAULT_OPTS = 0
 * TDBTLARGE = 1             # <<<<<<<<<<<<<<
 * TDBTDEFLATE = 1 << 1
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":25
 * DEF DEFAULT_OPTS = 0
 * TDBTLARGE = 1
 * TDBTDEFLATE = 1 << 1             # <<<<<<<<<<<<<<
 * TDBTBZIP = 1 << 2
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":27
 * TDBTDEFLATE = 1 << 1
 * TDBTBZIP = 1 << 2
 * TDBTTCBS = 1 << 3             # <<<<<<<<<<<<<<
 * TDBTEXCODEC = 1 << 4
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":28
 * TDBTBZIP = 1 << 2
 * TDBTTCBS = 1 << 3
 * TDBTEXCODEC = 1 << 4             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/usr/local/src/tctable/src/ctctable.pyx":31
 * 
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_21, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "/usr/local/src/tctable/src/ctctable.pyx":32
 * 
 * tokyo_cabinet_version = c_tcversion
 * __version__ = '0.1.1'             # <<<<<<<<<<<<<<
 * 
 ...
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s____version__, ((PyObject *)__pyx_kp_s_22)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "/usr/local/src/tctable/src/ctctable.pyx":34
 * __version__ = '0.1.1'
 * 
 * class TCException(Exception):             # <<<<<<<<<<<<<<
 *     '''An error communicating with the Tokyo Cabinet database.'''
 ...
 */
  ...
  if (PyDict_SetItemString(((PyObject *)__pyx_t_1), "__doc__", ((PyObject *)__pyx_kp_s_23)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = __Pyx_CreateClass(__pyx_t_2, ((PyObject *)__pyx_t_1), __pyx_n_s__TCException, "ctctable"); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /* "/usr/local/lib/python2.6/dist-packages/Cython/Includes/python_list.pxd":1
